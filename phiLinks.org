...
* Split Brains - Chapter 8

.  [[https://en.wikipedia.org/wiki/Carlo_Gesualdo][Prince of Venosa]]

   1. What is
      [[https://en.wikipedia.org/wiki/Diatonic_and_chromatic][chromatic]]
      music.
   2. Extract from film about him [[http://youtu.be/1rgBt5EkIKE][Death
      for Five Voices]]
   3. Example of his [[http://youtu.be/Fs_AgCTovik][compositions]]

.  Hemispherectomy is a procedure sometimes used to treat very severe
   epilepsy in young children. This
   [[http://epilepsyu.com/blog/video-hemispherectomy-radical-epilepsy-surgery-removes-half-brain/][page]]
   shows the image from the book and has a brief video on the
   procedure.
.  Brief NYTimes article on Gazzaniga (2011) that features some videos
   and talks about the split brain
   [[http://www.nytimes.com/2011/11/01/science/telling-the-story-of-the-brains-cacophony-of-competing-voices.html?pagewanted=all&_r=0][work]].
.  Another Gazzaniga video on [[http://youtu.be/zx53Zj7EKQE][split
   brain]] research.
.  If one hemisphere is enough for consciousness are we each comprised
   of two (or more) "people?"
.  If two people become one through the interposition of a corpus
   callosum does this provide support for the thesis of consciousness
   as integration?
.  [[./img/josepheniumFace.jpg]]
.  [[http://headneckbrainspine.com/web_flash/newmodules/Brain%20MRI.swf][Link
   to Corpus Callosum on MRI scans]] - needs Flash to work.
.  [[http://www.nejm.org/doi/full/10.1056/NEJM196304042681401][Cryogenic
   Neurosurgery]]
0. Temporary hemispheric inactivation. The
   [[http://www.neurology.org/content/61/5/699.short][Wada]] test.
1. Why does Tononi have the eyes frozen and unable to move?
2. [[http://youtu.be/sBbilBZ46Eg][Wada test video]]
3. What is the meaning of his name: Ishma --- El ? "Call me Ishmael."
   What is the source?
4. Why does Tononi make the claim: one who is blind from birth will
   never know what it is like to
   [[https://archive.org/stream/lockesessayconce00lock#page/67/mode/1up][see]]?
5. Odd that he uses the example of Indian tribe that always can tell
   whether someone is telling the truth?
   [[http://mathforum.org/dr.math/faq/faq.liar.html][Origin?]].
6. [[./img/veiledChrist.jpg]]

** Notes

. Link to Foville's
  [[https://archive.org/stream/influencedesvt00fovi#page/n5/mode/2up][book]]
